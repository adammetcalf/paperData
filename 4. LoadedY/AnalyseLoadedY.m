...
%read in sim data
sdata1 = csvread('VerticalLoadedSimulation.csv',1,0);
...
rdata1 = csvread('loadedY1.csv',1,0);
...
rdata2 = csvread('loadedY2.csv',1,0);
...
rdata3 = csvread('loadedY3.csv',1,0);
...
rdata4 = csvread('loadedY4.csv',1,0);
...
rdata5 = csvread('loadedY5.csv',1,0);
...
sgtitle({'Loaded Simulated MyPAM and Real MyPAM','Responses to a Y-Direction Trajectory Trajectory Demand'})
...
title({'Loaded Simulated MyPAM and Real MyPAM','Average Response to a Y-Direction Trajectory Demand'});
...
ylim([126.2-120,126.2+120]);
title('Y-position vs Time');
sgtitle({'Loaded Simulated MyPAM and Real MyPAM Average','Response to a Y-Direction Trajectory Trajectory Demand'})
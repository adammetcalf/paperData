...
%read in sim data
sdata1 = csvread('HorizontalLoadedSimulation.csv',1,0);
...
rdata1 = csvread('loadedX1.csv',1,0);
...
rdata2 = csvread('loadedX2.csv',1,0);
...
rdata3 = csvread('loadedX3.csv',1,0);
...
rdata4 = csvread('loadedX4.csv',1,0);
...
rdata5 = csvread('loadedX5.csv',1,0);
...
hold on
plot(aveX, aveY)
title({'Loaded Simulated MyPAM and Real MyPAM','Responses to a X-Direction Trajectory Demand'});
...
title({'Loaded Simulated MyPAM and Real MyPAM','Average Response to a X-Direction Trajectory Demand'});
...
ylim([126.2-20,126.2+20]);
title('Y-position vs Time');
sgtitle({'Loaded Simulated MyPAM and Real MyPAM Average','Response to a X-Direction Trajectory Trajectory Demand'})